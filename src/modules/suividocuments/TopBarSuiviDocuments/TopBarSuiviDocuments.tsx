...
import SuiviDocumentsFilter from "./SuiviDocumentsFilter";
import { ChevronDownIcon } from "@heroicons/react/20/solid";
import { FaFileExport } from "react-icons/fa6";

export default function TopBarSuiviDocuments() {
    ...
    <div className="bg-gray-100 px-10 pt-6 pb-4">
      ...
      <div className="flex items-center justify-between flex-wrap">
        <h2 className="text-sm font-bold text-cyan-600 uppercase tracking-wide">
          Dossier AYANT DES DOCUMENTS RECUS
        </h2>
        <div className="flex items-center gap-3">
          ...
          <button className="bg-cyan-700 text-white text-sm px-5 h-[30px] rounded hover:bg-cyan-800 transition flex items-center gap-2">
      ...
      {showFilters && (
        <div className="mt-4">
          <SuiviDocumentsFilter onApply={(f) => console.log("Documents filters:", f)} />
        </div>
      )}
    </div>
  );
